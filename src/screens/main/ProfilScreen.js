...
const styles = StyleSheet.create({
  ...
  avatarContainer: { width: 108, height: 108, borderRadius: 54,
    backgroundColor: colors.primary, justifyContent: 'center',
    alignItems: 'center', marginBottom: 16, overflow: 'hidden',
    borderWidth: 2, borderColor: colors.border, ...shadows.card },
  avatarBackground: { ...StyleSheet.absoluteFillObject, backgroundColor: colors.primaryDeep, opacity: 0.35 },
  ...
  menuItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingVertical: 16, paddingHorizontal: 16, backgroundColor: 'rgba(17, 27, 23, 0.96)',
